            ...
            {chats.map((chat) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <span className={`absolute bottom-0.3 right-0.5 h-3.5 w-3.5 rounded-full border-2 border-background z-20 ${onlineUsers.has(chat.otherUserId) ? 'bg-green-500' : 'bg-red-500'}`} />
                </div>
