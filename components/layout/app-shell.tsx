...
import { SparkyWebProvider } from "@/lib/hooks/use-sparky-web"
import { VisualAppearanceProvider } from "@/components/theme/visual-appearance-provider"
import { SparkyAssistantShell } from "@/components/sparky/sparky-assistant-shell"
    ...
    <VisualAppearanceProvider>
      <SparkyWebProvider>
        <div className="min-h-svh bg-background">
          ...
          {!isChatRoomRoute && <SparkyAssistantShell />}
          {!isChatRoomRoute && (
